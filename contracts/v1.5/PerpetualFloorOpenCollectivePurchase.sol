...
contract PerpetualFloorCollectivePurchase is ERC721Holder, Ownable, ReentrancyGuard
{
	...
	function list(address _collection, bool _listed, uint256 _fee, address _paymentToken, uint256 _priceMultiplier, bytes calldata _extra) external nonReentrant returns (uint256 _listingId)
	{
